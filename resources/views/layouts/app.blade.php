...
<body class="h-full bg-zinc-100 antialiased">
    ...
    <div class="flex min-h-full">
        ...
        <aside class="relative hidden w-[280px] shrink-0 flex-col lg:flex">
            ...
            ></div>
            {{-- Right hairline --}}
            <div class="pointer-events-none absolute inset-y-0 right-0 w-px bg-gradient-to-b from-transparent via-white/[0.08] to-transparent" aria-hidden="true"></div>

            <div class="relative flex flex-1 flex-col">
                <div class="px-5 pt-6 pb-5">
                    <a href="{{ route('deck.index') }}" class="block rounded-xl focus:outline-2 focus:outline-offset-2 focus:outline-indigo-400">
                ...
                <div class="px-4 pb-4">
                    ...
                    >
                        <svg class="size-3.5 shrink-0 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                        </svg>
                        <span class="flex-1">Search jobs, UUIDs…</span>
                        <kbd class="rounded-md bg-white/[0.06] px-1.5 py-0.5 font-mono text-[10px] text-zinc-400 ring-1 ring-white/10">⌘K</kbd>
                    </button>
                </div>
                ...
                <div class="px-5 pb-5">
                    <div class="flex flex-wrap items-center gap-2 text-[11.5px]">
                        <span class="inline-flex items-center gap-1.5 rounded-full bg-white/[0.04] px-2 py-0.5 font-mono text-zinc-300 ring-1 ring-white/[0.06]">
                            <span class="size-1.5 rounded-full bg-zinc-500" aria-hidden="true"></span>
                            {{ \TorMorten\Deck\Support\DeckInstallation::project() }}
                        </span>
                        <span class="inline-flex items-center gap-1.5 rounded-full bg-indigo-500/[0.12] px-2 py-0.5 font-mono text-indigo-200 ring-1 ring-indigo-400/20">
                ...
                <nav class="flex-1 space-y-8 overflow-y-auto px-3 pb-6">
                    <div>
                        <p class="mb-2.5 px-3 font-mono text-[10.5px] font-medium uppercase tracking-[0.16em] text-zinc-600">Operations</p>
                    ...
                    @if ($horizonUrl)
                        <div>
                            <p class="mb-2.5 px-3 font-mono text-[10.5px] font-medium uppercase tracking-[0.16em] text-zinc-600">Horizon</p>
                            <a
                                href="{{ $horizonUrl }}"
                            ...
                            >
                                <div class="flex items-center justify-between gap-3">
                                    <div class="min-w-0">
                                        ...
                                        <p class="mt-0.5 text-[11.5px] leading-relaxed text-zinc-500">Workers, throughput, supervisors</p>
                                    </div>
                                    <span class="flex size-7 shrink-0 items-center justify-center rounded-md bg-white/[0.04] text-zinc-400 ring-1 ring-inset ring-white/[0.06] transition group-hover:text-zinc-100">
                                        <svg class="size-3.5" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" /></svg>
                                    </span>
                                </div>
                            </a>
                        </div>
                ...
                <div class="border-t border-white/[0.04] px-5 py-4">
                    <div class="flex items-center gap-2 text-[11px] text-zinc-600">
                        <span class="size-1.5 rounded-full bg-emerald-500" style="box-shadow: 0 0 6px rgba(16,185,129,0.6);" aria-hidden="true"></span>
