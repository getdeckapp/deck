...
<a
    ...
    {{ $attributes->class([
        ...
        'bg-gradient-to-r from-amber-500/[0.18] via-amber-500/[0.10] to-transparent text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] ring-1 ring-inset ring-amber-400/20' => $active,
        'text-zinc-400 hover:bg-white/[0.04] hover:text-zinc-100' => ! $active,
    ]) }}
>
    @if ($active)
        <span
            class="absolute left-0 top-1/2 h-5 w-[3px] -translate-y-1/2 rounded-r-full bg-amber-400"
    ...
    <span @class([
        ...
        'bg-amber-500/20 text-amber-300' => $active,
