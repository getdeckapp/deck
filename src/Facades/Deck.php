 ...
 * @method static \Deck\Deck\Support\PendingCancelResult|null requestCancelExecution(string $uuid, ?int $attempt = null)
 * @method static \Deck\Deck\Support\PendingCancelResult|null forceCancelExecution(string $uuid, ?int $attempt = null)
 * @method static \Deck\Deck\Support\PendingCancelResult cancelPending(string $uuid, ?string $connection = null, ?string $queue = null, bool $force = false)
 * @method static \Deck\Deck\Support\RetryExecutionResult retryExecution(string $uuid, ?int $attempt = null)
 ...
 * @method static \Deck\Deck\Support\JobClassBlockAudit|null classBlockAudit(string $jobClass)
